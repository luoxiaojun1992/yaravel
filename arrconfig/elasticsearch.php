        ...
        'default' => [
            ...
            'hosts' => [
                [
                    ...
                    'aws'        => boolval(intval(env('AWS_ELASTICSEARCH_ENABLED', false))),
            ...
            'logging' => boolval(intval(env('ELASTICSEARCH_LOGGING', false))),

            // If you have an existing instance of Monolog you can use it here.
            // 'logObject' => \Log::getMonolog(),

            'logPath' => ROOT_PATH . DIRECTORY_SEPARATOR . 'storage' . DIRECTORY_SEPARATOR . 'logs' . DIRECTORY_SEPARATOR . 'elasticsearch.log',
            ...
            'sniffOnStart' => boolval(intval(env('ELASTICSEARCH_SNIFF_ON_START', false))),
